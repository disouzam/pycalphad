...
#git cherry-pick -x --no-commit a46b274da #Colorized output by highlighting number of mutants already checked and attached a cleaned git st and a diff to show some hint on what is going on during mutation testing
#git cherry-pick -x --no-commit 3f068fb94 #Partial update  of local distributor with 18729 mutants already checked, with 5753 surviving mutants
